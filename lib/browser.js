...
browser.openDialog = (html, ok_btn = true) => {
	...
	if (a = $('dialog form textarea, dialog form input')) a.focus();
	return $('dialog');
};
...
browser.setRowActions = (tr, file) => {
	...
	$$('.buttons .delete').onclick = (e) => {
		browser.openDialog(browser.has_trash ? browser.templates.trash_dialog : browser.templates.delete_dialog);
		$('#dialog_form').onsubmit = () => {
